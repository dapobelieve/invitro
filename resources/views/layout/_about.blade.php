                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 text-center">
                            ...
                            <p>We welcome applications from recent medical school graduates, nurses, doctors, physicians, and embryologists interested in Invitro Fertilization Services.</p>
                        </div>
                    </div>
                    <div class="row columns_margin_bottom_20">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="teaser hover_icon with_padding big-padding with_border rounded text-center with_corner_border">
                                ...
                                <p class="content-3lines-ellipsis">
                                    State of the art equipments in a serene environment to provide world class IVF training
                                </p>
                                {{--<p class="topmargin_30 bottommargin_0"> --}}
                                    {{--<a href="departments.html" class="theme_button color2 min_width_button">Discover Now</a> --}}
                                {{--</p> --}}
