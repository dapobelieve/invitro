                ...
                <div class="row">
                    <div class="col-md-6">
                        @foreach($courses as $course)
                            @if(!$loop->first)
                                <div class="panel-group" id="posts-accordion{{ $loop->index }}">
                                    <div class="panel panel-blog-post">
                                        <div class="panel-heading">
                                            <a data-toggle="collapse" data-parent="#posts-accordion{{ $loop->index }}" href="#blog-collapse{{ $loop->index + 1 }}"> </a>
                                        ...
                                        <div id="blog-collapse{{ $loop->index + 1 }}"
                                            ...
                                            <div class="panel-body">
                                                {!!  html_entity_decode(str_limit($course->content, 50))  !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
