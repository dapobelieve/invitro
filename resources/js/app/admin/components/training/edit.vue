            ...
            <div class="col-xs-12">
                ...
                <div class="widget-box">
                    <div class="widget-title">
                        ...
                        <h5>Edit Training <em v-if="upload.state">{{ upload.progress }}</em></h5>
                    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getTraining()
            {
                axios.get(`api/edit-training/${this.$route.params.id}`)
                    .then(response => {
            ...
            submitCourse ()
            {
                ...
                axios.post(`api/update-training/${this.course.id}`, td, {
                    headers: {
